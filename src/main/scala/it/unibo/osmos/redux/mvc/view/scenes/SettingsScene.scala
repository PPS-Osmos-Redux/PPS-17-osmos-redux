...
class SettingsScene(override val parentStage: Stage, listener: PrimaryStageListener, val upperSceneListener: UpperMultiPlayerSceneListener) extends BaseScene(parentStage) with MainMenuBarListener {
